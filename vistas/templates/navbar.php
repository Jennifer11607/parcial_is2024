      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="bi bi-file-person me-2"></i>COMIDA
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="../comida/index.php"><i class="bi bi-plus-circle me-2"></i>CREAR</a></li>
            <li><a class="dropdown-item" href="../comida/buscar.php"><i class="bi bi-search me-2"></i>BUSCAR</a></li>
          </ul>
        </li>
    </div>
</div>
